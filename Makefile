...
STD=gnu99
all:
	$(CC) -Wall -std=$(STD) -O2 -DSM3_MACRO -o sm3sum sm3sum.c sm3.c

perf:
	$(CC) -Wall -std=$(STD) -O2 -DSM3_MACRO -o sm3test_macro2 sm3test.c sm3.c
	$(CC) -Wall -std=$(STD) -O3 -DSM3_MACRO -o sm3test_macro3 sm3test.c sm3.c
